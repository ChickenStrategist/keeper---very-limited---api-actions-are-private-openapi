# Keeper Commander Service Mode REST API

Official OpenAPI 3.0 specification for Keeper - very limited - API actions are private API integration with Rewst.
...
## Description
Self-hosted REST wrapper around Keeper Commander CLI.
